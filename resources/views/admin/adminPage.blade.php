            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route("admin#adminList")}}">Admin List Page</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-5 col-5">
                    <div class="h4">Admin Total -> {{ count($admin) }} </div>
                </div>
                ...
                <div class=" table-responsive-sm">
                    <table class="table table-hover table-light mt-5 text-center align-middle">
                        ...
                        <tbody id="companyTable">
                            @foreach ($admin as $a)
                                <tr class="">
                                    <input type="hidden" name="" class="companyId" value="{{$a->id}}">
                                    <td class="align-middle">
                                        @if ($a->image == null)
                                            <img src="{{ asset('image/default.jpg') }}" style="width: 70px"
                                                class=" img-thumbnail" alt="">
                                        @else
                                            <img src="{{ asset('storage/' . $a->image) }}" style="width: 70px" alt="">
                                        @endif
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <p class="">{{ $a->email }}</p>
                                        <h5 class="text-muted">{{ $a->phone }}</h5>
                                    </td>
                                    <td class="align-middle">{{ $a->created_at->format('j-F-Y') }}</td>
                                    <td class="align-middle ">
                                       @if ($a->id =! Auth::user()->id)

                                       <div class="d-flex justify-content-center align-items-center">
                                        <a href="{{ route('admin#companyEdit', $a->id) }}"
                                            class=" text-decoration-none text-dark fs-4 mx-2"><i
                                                class="fa-solid fa-person-booth"></i></a>
                                        <a href="{{ route('admin#companyDelete', $a->id) }}"
                                            class="text-decoration-none text-dark fs-4 mx-2"> <i
